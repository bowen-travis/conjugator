     ...
     <TABLE id="controls">
        <TR>
          <TD> Language: <select id="language_selector" onChange="select_language(this.value);"><option value="None"></option> </select></TD>
    			<TD> Verb: <select id="verb_selector" onChange="select_verb('German',this.value);"> <option value="None"></option></select>&#x00a0; <input type="button" value="random" disabled="true"/></TD>
